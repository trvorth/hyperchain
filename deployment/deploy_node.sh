...
P2P_PORT="10333" # Your P2P port from the config file
...
# Create firewall rule if it does not already exist
...
gcloud compute instances create $INSTANCE_NAME \
    ...
    --metadata startup-script="#! /bin/bash
        # Log everything to a startup script log file
        ...
        # Note: The quotes around CONFIG_CONTENT are important
...
echo "   Once inside, you can check the logs with 'tail -f /var/log/startup-script.log' or attach to the session with 'screen -r hyperchain_node'"
