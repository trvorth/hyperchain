...
// Comprehensive error enumeration for the P2P layer.
#[derive(Error, Debug)]
pub enum P2PError {
...
// Defines the combined network behaviors for a node.
...
// Events generated by the combined network behaviors.
#[derive(Debug)]
...
// The structure of all messages sent over the P2P network.
...
// Configuration for initializing the P2P server.
#[derive(Clone)]
