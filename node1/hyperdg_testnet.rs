...
async fn main() {
    ...
    let config = Config {
        p2p_address: "/ip4/127.0.0.1/tcp/8080".to_string(),
        api_address: "0.0.0.0:9000".to_string(),
        peers: vec!["/ip4/127.0.0.1/tcp/8081".to_string(), "/ip4/127.0.0.1/tcp/8082".to_string()],
